...
public class CheckoutPage {
    ...
    public static final Target BTN_CHECKOUT = Target.the("Button to checkout").locatedForAndroid(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"CHECKOUT\").instance(0))")).locatedForIOS(AppiumBy.accessibilityId("test-CHECKOUT"));
